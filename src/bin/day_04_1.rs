...
fn main() {
    println!(
        "{}",
        fully_contained_assignment_count(&read_file_into_section_assignments(
...
fn fully_contained_assignment_count(
...
#[cfg(test)]
mod tests {
    use crate::{fully_contained_assignment_count, read_file_into_section_assignments};
    ...
    fn fully_contained_assignment_count_works() {
        assert_eq!(
            fully_contained_assignment_count(&vec![
                ((2..=4), (6..=8)),
                ((2..=3), (4..=5)),
                ((5..=7), (7..=9)),
                ((2..=8), (3..=7)),
